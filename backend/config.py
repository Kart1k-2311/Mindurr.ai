...
SUPABASE_ANON_KEY = os.getenv("SUPABASE_ANON_KEY") or settings.supabase_auth_key
SUPABASE_SERVICE_ROLE_KEY = os.getenv("SUPABASE_SERVICE_ROLE_KEY") or settings.supabase_service_key
SUPABASE_SERVICE_KEY = SUPABASE_SERVICE_ROLE_KEY
SUPABASE_JWT_SECRET = os.getenv("SUPABASE_JWT_SECRET")
AI_API_KEY = os.getenv("AI_API_KEY") or settings.gemini_api_key
AI_MODEL_API_KEY = os.getenv("AI_MODEL_API_KEY") or AI_API_KEY
